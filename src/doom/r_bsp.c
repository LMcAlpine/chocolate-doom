...
void R_AddLine(seg_t *line)
{
    ...
    // luke code
    int v1X = line->v1->x >> 16;
    int v1Y = line->v1->y >> 16;

    int v2X = line->v2->x >> 16;
    int v2Y = line->v2->y >> 16;
    // end luke code
    ...
    // angle1 = R_PointToAngle(960 << 16, -3648 << 16);
    // angle2 = R_PointToAngle(1024 << 16, -3648 << 16);
...
void R_RenderBSPNode(int bspnum, int *count)
{
    node_t *bsp;
    int side;
    ...
    R_RenderBSPNode(bsp->children[side], count);
    // R_RenderBSPNode (bsp->children[side^1],count);
